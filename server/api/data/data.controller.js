...
var dataStore = dataStoreLibrary.dataStore(); // COMMENT: this line does nothing

var router = express.Router();

router.get('/read', function read(req, res) {
  var count = 0;
...
router.post('/settings', function postSettings(req, res) {
  var count = 0;
...
router.get('/settings', function getSettings(req, res) {
  var count = 0;
  var transaction = dataStoreLibrary.transaction();
  var key = dataStoreLibrary.getRecordKey(req);
  dataStoreLibrary.readWidgetSettings(transaction, key)
